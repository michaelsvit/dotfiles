...
alias clo='vi ~/blt/app/main/core/sfdc/logs/sfdc/output.log'
alias cls='vi ~/blt/app/main/core/sfdc/logs/sfdc/suppressed.log'
alias clst='vi ~/blt/app/main/start.log'
alias clf='vi ~/.corecli.logs/fail'
